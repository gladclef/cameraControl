...
if ($global_opened_db === FALSE) {
	...
	{
		print_debug_as_html_paragraph("Unable to open database connection!");
	}
}
...
function open_db() {
	...
	if ($mysqli->connect_errno) {
		print_debug_as_html_paragraph("Unable to connect to MySQL. MySQLi errno $mysqli->connect_errno");
		return FALSE;
	}
	$global_opened_db = TRUE;
	return TRUE;
